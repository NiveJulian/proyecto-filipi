$(document).ready(function(){
            ...
            success: function (response) {
                ...
                if (Array.isArray(response) && response.length > 0) {
                    ...
                    response.forEach(function (opcion) {
                        ...
                        $('#tipo_registro_emitido').append('<option value="' + opcion.id + '" ' + selected + '>' + opcion.nombre + '</option>');
                    });
    ...
    function calcularTotal() {
        ...
        totalImpuestos += mostrarImpuesto("otros_impuestos", "calc_otro_impuestos_emitido");
    ...
    $("#subtotal_emitido, #iva, #itc, #idc, #perc_iibb, #perc_iva, #otros_impuestos, #descuento").on("input", function () {
        calcularTotal();
    });
    function rellenar_clientes() {
        let funcion = 'rellenar_clientes';
        $.post('/filippi/Controllers/ClienteController.php', { funcion }, (response) => {
