$(document).ready(function(){
    ...
    // PROVEEDOR
    $('#form-crear').submit(e=>{
        const telefonos = $('input[name="telefonos[]"]').map(function() {
            return $(this).val();
        }).get();
        ...
        $.post('/filippi/Controllers/ProveedorController.php',{id, nombre, direccion, cuit, razonsocial, condicion_iva, cbu, cvu, telefonos,  funcion}, (response)=>{
    ...
    async function obtener_proveedores() {
        ...
        let request = await fetch('/filippi/Controllers/ProveedorController.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'funcion=' + funcion
        });
        if (request.ok) {
            ...
            try {
                ...
                proveedores.forEach(proveedor => {
                    ...
                    const telefonosList = proveedor.telefonos.map(telefono => {
                    ...
                    template += `
                        <div provId="${proveedor.id}" 
                            ...
                            provCvu="${proveedor.cvu}" class="col-12 col-sm-8 col-md-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span><span class="badge badge-info"> Direccion:</span> ${proveedor.direccion}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-landmark"></i></span><span class="badge badge-info"> Razon Social:</span> ${proveedor.razon_social}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-id-card"></i></span><span class="badge badge-info"> C.U.I.T:</span> ${proveedor.cuit}</li>
                                            ${proveedor.cbu ? `<li class="small"><span class="fa-li"><i class="fas fa-university"></i></span><span class="badge badge-info"> CBU:</span> ${proveedor.cbu}</li>` : ''}
                                            ${proveedor.cvu ? `<li class="small"><span class="fa-li"><i class="fas fa-university"></i></span><span class="badge badge-info"> CVU:</span> ${proveedor.cvu}</li>` : ''}
                                        </ul>
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                        ...
                                        <img src="${proveedor.avatar}" alt="user-avatar" class="img-circle img-fluid img-md">
                                        </div>
                                    </div>
                                </div>
                ...
                proveedores.forEach(proveedor => {
                    ...
                    template+=`
                        <div provId="${proveedor.id}" 
                            ...
                            provCuit="${proveedor.cuit}" 
                            provCondicionIva="${proveedor.condicion_iva}" 
                            provAvatar="${proveedor.avatar}" class="d-flex justify-content-center align-items-center col-12 col-sm-2 col-md-12">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <ul class="ml-4 mb-0 fa-ul text-muted">
                                            ...
                                            <li class="small"><span class="fa-li"><i class="fas fa-lg fa-at"></i></span> Razon Social: ${proveedor.razon_social}</li>
                                            ${proveedor.cbu ? `<li class="small"><span class="fa-li"><i class="fas fa-university"></i></span><span class="badge badge-info"> CBU:</span> ${proveedor.cbu}</li>` : ''}
                                            ${proveedor.cvu ? `<li class="small"><span class="fa-li"><i class="fas fa-university"></i></span><span class="badge badge-info"> CVU:</span> ${proveedor.cvu}</li>` : ''}
                                        ...
                                        <img src="${proveedor.avatar}" alt="user-avatar" class="img-circle img-fluid img-lg">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
    ...
    $('#form-logo').submit(e=>{
        ...
        $.ajax({
            url:'/filippi/Controllers/ProveedorController.php',
            type:'POST',
            data: formData,
            cache: false,
            processData: false,
    ...
    $(document).on('click', '.borrar-proveedor', (e)=>{
        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.value) {
                $.post('/filippi/Controllers/ProveedorController.php',{id,funcion}, (response)=>{
                    if(response=='borrado'){
                        swalWithBootstrapButtons.fire(
                            'Borrado!',
