                        ...
                        columns: [
                            {
                                "render": function (data, type, datos, meta) {
                                        ...
                                        let vto_cedula = (datos.vencimiento_cedula !== "" && datos.vencimiento_cedula !== null) ? `<li class="h8 text-sm"><span class="fa-li"><i class="fas fa-calendar-day"></i></span><b>VTO. Cedula:</b> ${datos.vencimiento_cedula}</li>` : '';
                                        let vtv = (datos.vtv !== "" && datos.vtv !== null) ? `<li class="h8 text-sm"><span class="fa-li"><i class="fas fa-wrench"></i></span><b>VTO. VTV.:</b> ${datos.vtv}</li>` : '';
                                        let logistica = (datos.logistica !== "" && datos.logistica !== null) ? `<li class="h8 text-sm"><span class="fa-li"><i class="fas fa-calendar-alt"></i></span><b>R.U.T.A:</b> ${datos.logistica}</li>` : '';
                                        let senasa = (datos.senasa !== "" && datos.senasa !== null) ? `<li class="h8 text-sm"><span class="fa-li"><i class="far fa-calendar"></i></span><b>VTO Senasa:</b> ${datos.senasa}</li>` : '';
                                        ...
                                        let seguro = (datos.seguro !== "" && datos.seguro !== null) ? `<li class="h8 text-sm"><span class="fa-li"><i class="fas fa-calendar"></i></span><b>Pago Seguro:</b> ${datos.seguro}</li>` : '';
                                        let poliza = (datos.poliza !== "" && datos.poliza !== null) ? `<li class="h8 text-sm"><span class="fa-li"><i class="far fa-calendar-times"></i></span><b>VTO Poliza:</b> ${datos.poliza}</li>` : '';
