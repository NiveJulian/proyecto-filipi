            ...
            <div class="row">
              <div class="col-lg-6 border-right">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="number" name="horas" id="horas" placeholder="Ingresar horas de trabajo"></input>
                </div>
                <div class="form-group">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="../catalogo.php">Inicio</a></li>
            ...
            <div class="col-md-4">
              <div class="text-center card">
                <div class="card-body">
                  ...
                  <div class="card-footer">
                    <span id="total_historico">0</span>
                  </div>
                </div>
              </div>
              <div class="text-center card">
            ...
            <div class="col-md-4">
              <div class="text-center card">
                <div class="card-body">
                  ...
                  <form>
                    <div class="form-group">
                      <label for="ultimo_service">Ultimo Servis:</label>
...
?>
<script src="/filippi/Views/layouts/Consumo.js"></script>