                        ...
                        <form id="form-login" class="login-form">
                            ...
                            <div id="input-container">
                                <div class="form-group">
                                    <label for="dni" class="control-label">CUIT</label>
                            ...
                            <input type="submit" id="btn-iniciar-sesion" class="btn btn-secondary w-100" value="Iniciar Sesión">
                            <button type="button" id="btn-validar-codigo" class="btn btn-success w-100" style="display: none;">
                                Validar Código
                            </button>
