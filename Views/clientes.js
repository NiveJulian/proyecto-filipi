$(document).ready(function(){
    ...
    async function obtener_cliente() {
        ...
        let request = await fetch('/filippi/Controllers/ClienteController.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
            body: 'funcion=' + funcion
        });
    ...
    $('#form-crear-cliente').submit(e=>{
        ...
        $.post('/filippi/Controllers/ClienteController.php',{ nombre, direccion, telefono, cuit, razonsocial, condicion_iva, funcion }, (response)=>{
            if (response=='add'){
    ...
    $('#form-logo').submit(e=>{
        ...
        $.ajax({
            url:'/filippi/Controllers/ClienteController.php',
            type:'POST',
            data: formData,
            cache: false,
            processData: false,
    ...
    $(document).on('click', '.borrar', (e)=>{
        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.value) {
                $.post('/filippi/Controllers/ClienteController.php',{id,funcion}, (response)=>{
                    edit==false;
                    if(response=='borrado'){
                        swalWithBootstrapButtons.fire(
                            'Borrado!',
